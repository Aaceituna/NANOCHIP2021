...
create_lib ALU_SYN.ndm -technology /usr/synopsys/TSMC/180/CMOS/G/stclib/7-track/tcb018gbwp7t_290a_FE/TSMCHOME/digital/Back_End/milkyway/tcb018gbwp7t_270a/techfiles/tsmc018_6lm.tf \
 -ref_libs /mnt/nfs/compartida/ASA/LibreriasNDM/TSMCWorkspace.ndm

#Abrimos el verilog file sintetizado
read_verilog /mnt/nfs/compartida/ALU4b/sintesis_logica/Sintesis_cell_io/salidas/ALU4_io_out.v

read_sdc -echo /mnt/nfs/compartida/ALU4b/sintesis_logica/Sintesis_cell_io/salidas/ALU4_io_out.sdc
...
initialize_floorplan -site_def unit -use_site_row -keep_all -side_length {350 350} -core_offset {125}
#create_site_row -name filas_core -site unit -origin {125.000 125.000} -site_count 100

#Creación del anillo IO
create_io_ring -name anillo_IO_ALU -bbox {{0.0000 0.0000} {600.0000 598.8800}} -corner_height 115
...
#set_power_io_constraints -io_guide_object [get_io_guides {anillo_IO_ALU.right anillo_IO_ALU.left}] -reference_cell {PVDD1CDG PVSS1CDG}
...
set_pg_strategy mesh_strategy -polygon {{125.000 118.000} {475.000 480.880}} -pattern {{pattern: mesh_pattern}{nets: {VDD VSS}}} -blockage {macros: all}
create_pg_std_cell_conn_pattern std_cell_pattern
set_pg_strategy std_cell_strategy -polygon {{125.000 118.000} {475.000 480.880}} -pattern {{pattern: std_cell_pattern}{nets: {VDD VSS}}}
compile_pg 
#-ignore_via_drc
...
create_io_filler_cells -io_guides [get_io_guides {anillo_IO_ALU.top anillo_IO_ALU.right anillo_IO_ALU.left anillo_IO_ALU.bottom}] \
-reference_cells {PFILLER1 PFILLER5 PFILLER05 PFILLER0005 PFILLER10 PFILLER20} \
-extension_bbox {{0.0000 0.0000} {600.0000 598.8800}}
...
set_app_options -list {signoff.check_design.run_dir {/home/nanoelectronica2021/Documentos/Sintesis_Fisica_ALU4b1/DRC/}}
set_app_options -list {signoff.check_drc.run_dir {/home/nanoelectronica2021/Documentos/Sintesis_Fisica_ALU4b1/DRC/}}
