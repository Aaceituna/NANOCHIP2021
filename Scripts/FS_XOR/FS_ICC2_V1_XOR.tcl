...
create_lib XOR_SYN.ndm -technology /usr/synopsys/TSMC/180/CMOS/G/stclib/7-track/tcb018gbwp7t_290a_FE/TSMCHOME/digital/Back_End/milkyway/tcb018gbwp7t_270a/techfiles/tsmc018_6lm.tf \
 -ref_libs /mnt/nfs/compartida/ASA/LibreriasNDM/TSMCWorkspace.ndm

#Abrimos el verilog file sintetizado
read_verilog /mnt/nfs/compartida/XOR/sintesis_logica/xor/sintesis_xor_io/salidas/out_xor_io.v

read_sdc -echo -syntax_only /mnt/nfs/compartida/XOR/sintesis_logica/xor/sintesis_xor_io/salidas/out_xor_io.sdc
...
initialize_floorplan -site_def unit -use_site_row -keep_all -side_length {100 100} -core_offset {130}
...
set_pg_strategy mesh_strategy -polygon {{130.000 123.000} {229.680 235.000}} -pattern {{pattern: mesh_pattern}{nets: {VDD VSS}}} -blockage {macros: all}
create_pg_std_cell_conn_pattern std_cell_pattern
set_pg_strategy std_cell_strategy -polygon {{130.000 123.000} {229.680 235.000}} -pattern {{pattern: std_cell_pattern}{nets: {VDD VSS}}}
compile_pg 
#-ignore_via_drc
...
-extension_bbox {{0.000 0.000} {359.680 358.000}}
...
set_app_options -list {signoff.check_design.run_dir {/home/nanoelectronica2021/Documentos/SintesisFisica_XOR1/DRC/}}
set_app_options -list {signoff.check_drc.run_dir {/home/nanoelectronica2021/Documentos/SintesisFisica_XOR1/DRC/}}
