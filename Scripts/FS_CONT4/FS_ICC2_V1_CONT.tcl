...
create_lib CONT_SYN.ndm -technology /usr/synopsys/TSMC/180/CMOS/G/stclib/7-track/tcb018gbwp7t_290a_FE/TSMCHOME/digital/Back_End/milkyway/tcb018gbwp7t_270a/techfiles/tsmc018_6lm.tf \
 -ref_libs /mnt/nfs/synopsys/Compartida_NFS/ASA/LibreriasNDM/TSMCWorkspace.ndm

#Abrimos el verilog file sintetizado
read_verilog /mnt/nfs/synopsys/Compartida_NFS/counter4B/sintesis_logica/Sintesis_cell_io/salidas/counter4_io_out.v

read_sdc -echo /mnt/nfs/synopsys/Compartida_NFS/counter4B/sintesis_logica/Sintesis_cell_io/salidas/counter4_io_out.sdc
...
#Floorplan inicial
initialize_floorplan -site_def unit -use_site_row -keep_all -side_length {150 150} -core_offset {125}
...
set_pg_strategy mesh_strategy -polygon {{125.000 118.000} {274.520 280.960}} -pattern {{pattern: mesh_pattern}{nets: {VDD VSS}}} -blockage {macros: all}
...
create_io_filler_cells -io_guides [get_io_guides {anillo_IO_CONT.top anillo_IO_CONT.right anillo_IO_CONT.left anillo_IO_CONT.bottom}] \
