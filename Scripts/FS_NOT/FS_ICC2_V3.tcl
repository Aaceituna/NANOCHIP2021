...
set_pg_strategy std_cell_strategy -polygon {{125.000 119.000} {224.670 229.000}} -pattern {{pattern: std_cell_pattern}{nets: {VDD VSS}}}
compile_pg 
#-ignore_via_drc
...
set_app_options -list {signoff.check_design.run_dir {/home/nanoelectronica2021/Documentos/SintesisFisica_NOT3/DRC/}}
set_app_options -list {signoff.check_drc.run_dir {/home/nanoelectronica2021/Documentos/SintesisFisica_NOT3/DRC/}}
